...
from edd.grafo.grafo import Grafo, Grafo_ponderado, Vertice, Arista
...
class Test_grafo(TestCase):
    ...
    def test_grafo_ponderado(self):
        gp = Grafo_ponderado()
        gp.agregar_aristas(('x','y',1))
        gp.existe_vertice( gp.existe_vertice('x'))
    ...
    def test_dijkstra_con_1_arista(self):
        self.g = Grafo_ponderado()
        self.g.agregar_aristas(('a','b',4))
